...
def evaluate(model, model_name, dataloader, loss_fn, steps, class_info, device='cpu', pbar=True):
    model.eval()
    logits = []
    current_loss = 0
    with torch.no_grad():
...
if __name__ == '__main__':
    ...
    parser.add_argument('-r', '--root', type=str, help='root directory of the dataset', default=r"D:\Thi_Giac_May_Tinh\data1")
    ...
    parser.add_argument('--evaluate_frequently', type=int, help='frequency of evaluation', default=200)
    parser.add_argument('--num_gradient_per_update', type=int, help='number of gradients per update', default=20)
